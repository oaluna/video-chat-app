...
const VideoCall = () => {
  ...
  const userDetails=(
    <div>Send your username<b color="red">{yourID}</b></div>
  )
  ...
  const dialogBox = (
    ...
    >
      ...
      <DialogContent>
        <DialogContentText>
          Enter the user Id you want to connect
        </DialogContentText>
        <TextField
          autoFocus
          margin="dense"
      ...
      <DialogActions>
        ...
        <Button onClick={() => callPeer(receiverID.toLowerCase().trim())} color="secondary">
          Call
        </Button>
      </DialogActions>
    </Dialog>
